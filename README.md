...
> The original paper (Gräßer et al.) achieved ~75% accuracy on a simplified 3-class version of this problem. This model solves the harder 10-class variant, where ~80% of predictions land within 2 stars of the true rating.
...
│
│
├── report/                          #Project's Documentation
│
└── README.md
```
...
![Rating Distribution](figures/rating-distribution.png)
